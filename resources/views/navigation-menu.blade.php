        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('state.index') }}" :active="request()->routeIs('state.index')">
                        {{ __('Estados') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('city.index') }}" :active="request()->routeIs('city.index')">
                        {{ __('Cidades') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('district.index') }}" :active="request()->routeIs('district.index')">
                        {{ __('Bairros') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('accountType.index') }}" :active="request()->routeIs('accountType.index')">
                        {{ __('Prêmios') }}
                    </x-jet-nav-link>
